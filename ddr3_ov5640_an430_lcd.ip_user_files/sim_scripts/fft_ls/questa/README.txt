...
#
# Generated by export_simulation on Thu Apr 10 10:41:21 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './fft_ls.sh' script.
...
./fft_ls.sh -noclean_files

For more information on the script, please type './fft_ls.sh -help'.
