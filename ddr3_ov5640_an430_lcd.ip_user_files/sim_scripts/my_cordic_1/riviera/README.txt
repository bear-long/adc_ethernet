...
#
# Generated by export_simulation on Sat Apr 12 18:24:59 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './my_cordic_1.sh' script.

./my_cordic_1.sh -reset_run
...
./my_cordic_1.sh -noclean_files

For more information on the script, please type './my_cordic_1.sh -help'.
