...
HD_PWD='I:/ax7103_2019.1/demo/24_ad9280_ethernet/adc_ethernet.runs/afifo_16i_64o_512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afifo_16i_64o_512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afifo_16i_64o_512.tcl
