...
HD_PWD='I:/ax7103_2019.1/demo/24_ad9280_ethernet/adc_ethernet.runs/afifo_64i_16o_128_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log afifo_64i_16o_128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source afifo_64i_16o_128.tcl
